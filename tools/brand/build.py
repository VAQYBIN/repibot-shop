...
# высота получается сама. Охранное поле — раздел 4, не меньше 1.5x, для FULL
# это 35 px. При 0.34 поле сверху и снизу выходит 89 px: доля выбрана по
# композиции, охранное поле при ней выполняется с большим запасом.
BANNER_RATIO = 0.34
