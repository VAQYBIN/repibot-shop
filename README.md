...
Текущее состояние: подпроект 1a «Идентичность» — вход и профиль. Регистрация по почте
с подтверждением, вход паролем в вебе и по `initData` в MiniApp, профиль, язык, список
сессий и роли. Тарифов, подписок и оплат пока нет.
