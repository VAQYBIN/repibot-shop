...
Текущее состояние: подпроекты 0–6 реализованы — фундамент, идентичность,
подписки, деньги, коммуникации, админка и переработка дизайна. Продающего
лендинга ещё нет: `/` остаётся заглушкой до отдельного захода вместе с текстами.
