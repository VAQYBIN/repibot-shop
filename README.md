...
Текущее состояние: подпроекты 1 «Идентичность» и 2 «Подписки и Remnawave»
реализованы целиком. Для этапа 2b остаётся внешний приёмочный прогон против
живой Remnawave 3.2.1; автоматизированный контур проверяется через HTTP-заглушку.
...
Пока нет оплат и уведомлений — это следующие подпроекты.
