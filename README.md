...
Текущее состояние: подпроекты 0–5 реализованы — фундамент, идентичность,
подписки, деньги, коммуникации и админка. Остался подпроект 6 «Переработка
дизайна»: внешний вид доводится последним, когда набор экранов перестал расти.
