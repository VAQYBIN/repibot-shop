...
def render_notification(
    ...
    Тело разбивается на абзацы по переводам строк, как и у остальных писем.
    Одним абзацем ссылка отписки склеивалась бы с текстом уведомления в
    сплошную строку — в почтовом клиенте это выглядит опечаткой, а не сноской.
    """
    html = _LAYOUT.render(
        language=language,
