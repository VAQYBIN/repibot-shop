...
export default defineConfig({
  testDir: './e2e',
  // Подмена главной живёт в своём прогоне: ей нужен пересозданный nginx с
  // пробным каталогом, а здесь главную отдаёт приложение. Без этого запрета
  // общий обход подобрал бы её вместе с остальными и падал бы всегда.
  testIgnore: 'custom-landing.spec.ts',
